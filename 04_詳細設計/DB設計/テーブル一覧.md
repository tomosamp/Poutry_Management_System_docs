...
| 13 | monthly_aggregate_values | 月次集計値（全国/地区） | id | bird_species_id, region_block_id(NULL=全国), target_month, data_kind, metric_key, value_integer, aggregate_version_no | bird_species_id + region_block_id + target_month + data_kind + metric_key | bird_species.id ⇔ monthly_aggregate_values.bird_species_id / region_blocks.id ⇔ monthly_aggregate_values.region_block_id | `docs/04_詳細設計/DB設計/13_monthly_aggregate_values.md` | 成鶏は全国のみ（region_block_idはNULL） |
