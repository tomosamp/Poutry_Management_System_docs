...
| インデックス | ユニーク/通常、複合を明示。 | 例: `login_id (UNIQUE)` |
...
|---|---|---|---|---|---|---|---|---|
| 01 | admins | 職長協会向け管理アカウント | id | login_id, password, last_name, first_name, deleted_at | login_id (UNIQUE) | - | - | メール不要。passwordはハッシュ保持 |
